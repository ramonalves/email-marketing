  ...
  <div>
    <menu type="context" id="menu" v-if="me">
      <ul class="side-nav">
        <li>
          <div class="user-view">
            <img src="https://secure.gravatar.com/avatar/d54707a89a28433483e919ec26e36dd3.jpg?d=mm&r=g&s=150" class="circle">
    ...
    <section id="page">
      ...
      <footer id="footer" class="row grey lighten-3">
        <div class="col s12">
          <small>by <a href="https://www.linkedin.com/in/ramon-alves-de-souza-57276b34/"> Ramon Alves</a></small>
        </div>
      </footer>
    </section>
  </div>
